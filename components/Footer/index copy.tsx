...
export const Footer = () => {
  return (
    <footer className="px-6 py-6 ui-footer idc-footer bg-idc-blue-700 md:px-8 md:py-10">
      <div className="idc-footer-details"></div>
      <div className="idc-footer-disclaimer"></div>
      ...
      <div className="bg-idc-blue-800">
        <div className="flex max-w-5xl mx-auto">
          <div>
            <p className="bg-white">BBB Logo</p>
          ...
          <div>
            <p className="ml-auto bg-white">
              Copyright © 2020 International Documents Canada. All rights
              reserved.
            </p>
            <p className="ml-auto bg-white">About Us | Privacy Policy</p>
          </div>
        </div>
      </div>
    </footer>
